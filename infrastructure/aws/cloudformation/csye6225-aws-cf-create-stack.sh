...
WebServerSubnet3_Name="${Stack_Name}-csye6225-web-server-subnet-3"
DBServerSubnet_Name="${Stack_Name}-csye6225-db-server-subnet"
DBServerSubnet2_Name="${Stack_Name}-csye6225-db-server-subnet-2"
DBServerSubnet3_Name="${Stack_Name}-csye6225-db-server-subnet-3" 
